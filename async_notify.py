...
class AsyncNotify():
            ...
            while self.__listening:
                if select([self.conn],[],[],self.timeout) != ([],[],[]):
                    ...
                    while self.conn.notifies:
                        ...
                        self.gotNotify(notify.pid, notify)
    ...
    def gotNotify(self, pid, notify):
        """should be subclassed and processed once implemented"""
        pass
    def respondNotify(self, pid, notify):
        """should be subclassed and implemented"""
        pass
